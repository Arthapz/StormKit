...
namespace stormkit::gpu {
    ...
    PhysicalDevice::PhysicalDevice(VkPhysicalDevice physical_device) noexcept
        ...
        stdr::copy(std::string_view { properties.deviceName, device_name_size },
                   std::begin(m_device_info.device_name));
        ...
        m_capabilities.limits
          .max_sampler_allocation_count = properties.limits.maxSamplerAllocationCount;
        ...
        m_capabilities.limits
          .max_per_stage_descriptor_uniform_buffers = properties.limits
                                                        .maxPerStageDescriptorUniformBuffers;
        m_capabilities.limits
          .max_per_stage_descriptor_storage_buffers = properties.limits
                                                        .maxPerStageDescriptorStorageBuffers;
        m_capabilities.limits
          .max_per_stage_descriptor_sampled_images = properties.limits
                                                       .maxPerStageDescriptorSampledImages;
        m_capabilities.limits
          .max_per_stage_descriptor_storage_images = properties.limits
                                                       .maxPerStageDescriptorStorageImages;
        m_capabilities.limits
          .max_per_stage_descriptor_input_attachments = properties.limits
        ...
        m_capabilities.limits
          .max_descriptor_set_uniform_buffers_dynamic = properties.limits
                                                          .maxDescriptorSetUniformBuffersDynamic;
        m_capabilities.limits
          .max_descriptor_set_storage_buffers = properties.limits.maxDescriptorSetStorageBuffers;
        m_capabilities.limits
          .max_descriptor_set_storage_buffers_dynamic = properties.limits
        ...
        m_capabilities.limits
          .max_descriptor_set_input_attachments = properties.limits
        ...
        m_capabilities.limits
          .max_tessellation_generation_level = properties.limits.maxTessellationGenerationLevel;
        m_capabilities.limits
          .max_tessellation_patch_size = properties.limits.maxTessellationPatchSize;
        ...
        m_capabilities.limits
          .max_geometry_total_output_components = properties.limits
        ...
        m_capabilities.limits
          .max_fragment_combined_output_resources = properties.limits
        ...
        m_capabilities.limits
          .optimal_buffer_copy_offset_alignment = properties.limits
                                                    .optimalBufferCopyOffsetAlignment;
        m_capabilities.limits
          .optimal_buffer_copy_row_pitch_alignment = properties.limits
        ...
        m_extensions = *vk_enumerate<VkExtensionProperties>(vkEnumerateDeviceExtensionProperties,
                       ...
                       | std::views::transform([](auto&& extension) noexcept {
                             const auto
                               string_size = std::char_traits<char>::length(extension
                                                                              .extensionName);

                             auto string = std::string {};
                             string.resize(string_size);
                             stdr::copy(std::string_view { extension.extensionName, string_size },
                                        std::begin(string));
                             return string;
                         })
