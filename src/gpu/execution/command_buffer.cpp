...
namespace stormkit::gpu {
    namespace {
        ...
        struct CommandBufferAPI {
            ...
            static auto reset(CommandBufferType& cmb) noexcept -> Expected<void> {
                ...
                EXPECTS(state == State::RECORDING);

                const auto& device       = cmb.device();
                const auto& device_table = device.device_table();

                Try(vk::call_checked(m_vk_device_table->vkResetCommandBuffer, m_vk_handle, 0));
                state = State::INITIAL;
            ...
            static auto begin(CommandBufferType& cmb, bool one_time_submit, InheritanceInfo inheritance_info_variant) noexcept
              -> Expected<void> {
                auto& state = cmb.state();
                EXPECTS(state == State::INITIAL);
                ...
                auto vk_rendering_inheritance_info = VkCommandBufferInheritanceRenderingInfo {
                ...
                const auto vk_inheritance_info =
                  [&inheritance_info_variant, &rendering_color_attachments, &vk_rendering_inheritance_info] noexcept {
                      ...
                      auto info = VkCommandBufferInheritanceInfo { .sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_INFO };
                ...
                Try(vk::call_checked(m_vk_device_table->vkBeginCommandBuffer, m_vk_handle, &begin_info));
            ...
            /////////////////////////////////////
            template<meta::IsOwnedOrView CommandBufferType>
            static auto begin_debug_region(const CommandBufferType& cmb,
                                           std::string_view&&       name,
                                           const fcolor_rgb&        color) noexcept -> void {
                const auto& state = cmb.state();
                EXPECTS(state == State::RECORDING);
            ...
            /////////////////////////////////////
            template<meta::IsOwnedOrView CommandBufferType>
            static auto insert_debug_label(const CommandBufferType& cmb,
                                           std::string_view&&       name,
                                           const fcolor_rgb&        color) noexcept -> void {
                const auto& state = cmb.state();
                EXPECTS(state == State::RECORDING);
            ...
            /////////////////////////////////////
            template<meta::IsOwnedOrView CommandBufferType>
            static auto begin_rendering(const CommandBufferType& cmb, const RenderingInfo& info, bool secondary) noexcept
              -> void {
                ...
                const auto
                  vk_clear_values = transform(clear_values,
                                              cmonadic::either(
                                                ...
                                                [](const ClearDepthStencil& clear_depth_stencil) static noexcept
                                                  -> decltype(auto) {
                                                    return VkClearValue {
            ...
            /////////////////////////////////////
            template<meta::IsOwnedOrView CommandBufferType>
            auto set_viewport(const CommandBufferType& cmb, u32 first_viewport, std::span<const Viewport>&& viewports) noexcept
              -> void {
                const auto& state = cmb.state();
                EXPECTS(state == State::RECORDING);
            ...
            /////////////////////////////////////
            template<meta::IsOwnedOrView CommandBufferType>
            auto set_scissor(const CommandBufferType& cmb, u32 first_scissor, std::span<const Scissor>&& scissors) noexcept
              -> void {
                const auto& state = cmb.state();
                EXPECTS(state == State::RECORDING);
            ...
            /////////////////////////////////////
            template<meta::IsOwnedOrView CommandBufferType>
            static auto set_stencil_reference(const CommandBufferType& cmb, StencilFaceFlag face, u32 reference) noexcept
              -> void {
                const auto& state = cmb.state();
                EXPECTS(state == State::RECORDING);
            ...
            static auto draw_indexed(const CommandBufferType& cmb,
                ...
                vk::call(device_table.vkCmdDrawIndexed,
                         cmb,
                         index_count,
                         instance_count,
                         first_index,
            ...
            /////////////////////////////////////
            template<meta::IsOwnedOrView CommandBufferType>
            auto bind_vertex_buffers(const CommandBufferType&  cmb,
                                     std::span<view::Buffer>&& buffers,
            ...
            static auto bind_descriptor_sets(const CommandBufferType&         cmb,
                                             ...
                                             std::span<view::DescriptorSet>&& descriptor_sets,
            ...
            static auto copy_buffer(const CommandBufferType& cmb,
                ...
                const auto vk_copy_buffers = into_array_of<VkBufferCopy>({ .srcOffset = src_offset,
            ...
            static auto copy_buffer_to_image(const CommandBufferType&           cmb,
                ...
                const auto DEFAULT_COPY = into_array_of<BufferImageCopy>({
                  0,
                  0,
                  0,
                  {},
            ...
            static auto pipeline_barrier(const CommandBufferType&               cmb,
                ...
                const auto vk_memory_barriers        = transform(memory_barriers,
                ...
                const auto
                  vk_image_memory_barriers = transform(image_memory_barriers,
                                                       [](const auto& barrier) static noexcept -> decltype(auto) {
                                                           const auto vk_subresource_range = VkImageSubresourceRange {
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    auto CommandBuffer::set_depth_bounds(u32 min, u32 max) const noexcept -> const CommandBuffer& {
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    auto CommandBuffer::dispatch(u32 group_count_x, u32 group_count_y, u32 group_count_z) const noexcept -> void {
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    auto CommandBuffer::draw(u32 vertex_count, u32 instance_count, u32 first_vertex, u32 first_instance) const noexcept -> void {
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    auto CommandBuffer::draw_indirect(view::Buffer buffer, usize offset, u32 draw_count, u32 stride) const noexcept -> void {
    ...
    auto CommandBuffer::blit_image(view::Image                 src,
        ...
        CommandBufferAPI::blit_image(*this, std::move(src), std::move(dst), src_layout, dst_layout, regions, filter);
        return *this;
    }
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    auto CommandBuffer::push_constants(const view::PipelineLayout& pipeline_layout,
                                       ShaderStageFlag             stage,
                                       std::span<const byte>       data,
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    auto CommandBuffer::do_init(PrivateTag,
                                view::CommandPool  pool,
                                CommandBufferLevel level,
                                VkCommandBuffer&&  handle,
                                Deleter&&          deleter) const noexcept -> Expected<void> {
        m_pool  = pool;
        m_level = level;
    ...
    namespace view {
        ...
        auto CommandBuffer::draw_indexed(u32 index_count,
                                         ...
                                         u32 first_index,
                                         i32 vertex_offset,
                                         u32 first_instance) const noexcept -> void {
            CommandBufferAPI::draw_indexed(*this, index_count, instance_count, first_index, vertex_offset, first_instance);
            return *this;
        }
        ...
        /////////////////////////////////////
        /////////////////////////////////////
        auto CommandBuffer::draw_indirect(const Buffer& buffer, usize offset, u32 draw_count, u32 stride) const noexcept -> void {
            CommandBufferAPI::draw_indirect(*this, std::move(buffer), offset, draw_count, stride);
            return *this;
        }
        ...
        /////////////////////////////////////
        /////////////////////////////////////
        auto CommandBuffer::draw_indexed_indirect(const Buffer& buffer, usize offset, u32 draw_count, u32 stride) const noexcept
          -> void {
            CommandBufferAPI::draw_indexed_indirect(*this, std::move(buffer), offset, draw_count, stride);
            return *this;
        }
        ...
        /////////////////////////////////////
        /////////////////////////////////////
        auto CommandBuffer::copy_buffer(const Buffer& src, const Buffer& dst, usize size, u64 src_offset, u64 dst_offset)
          const noexcept -> const CommandBuffer& {
            CommandBufferAPI::copy_buffer(*this, src, dst, size, src_offset, dst_offset);
            return *this;
        }
        ...
        auto CommandBuffer::transition_image_layout(const Image&                 image,
                                                    ...
                                                    const ImageSubresourceRange& subresource_range) const noexcept
          -> const CommandBuffer& {
            CommandBufferAPI::transition_image_layout(*this, image, src_layout, dst_layout, subresource_range);
            return *this;
        }
        ...
        auto CommandBuffer::push_constants(const PipelineLayout& pipeline_layout,
                                           ...
                                           std::span<const byte> data,
                                           u32                   offset) const noexcept -> const CommandBuffer& {
            CommandBufferAPI::push_constants(*this, pipeline_layout, stage, data, offset);
            return *this;
        }
        ...
        auto CommandBuffer::execute_sub_command_buffers(std::span<const CommandBuffer> command_buffers) const noexcept
          -> const CommandBuffer& {
            CommandBufferAPI::execute_sub_command_buffers(*this, command_buffers);
            return *this;
        }
    } // namespace view
} // namespace stormkit::gpu
