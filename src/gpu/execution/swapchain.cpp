...
namespace stormkit::gpu { namespace {
    /////////////////////////////////////
    /////////////////////////////////////
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    auto choose_swap_extent(const VkSurfaceCapabilitiesKHR& capabilities, const math::uextent2& extent) noexcept -> VkExtent2D {
        ...
        actual_extent
          .width = std::max(capabilities.minImageExtent.width, std::min(capabilities.maxImageExtent.width, actual_extent.width));
    ...
    struct SwapChainAPI {
        ...
        static auto acquire_next_image(const SwapChainType&     swapchain,
            ...
            auto id = u32 { 0 };
            Try(vk::call_checked<VkResult, VK_ERROR_OUT_OF_DATE_KHR, VK_SUBOPTIMAL_KHR>(device_table->vkAcquireNextImageKHR,
                                                                                        device,
                                                                                        swapchain,
                                                                                        wait.count(),
                                                                                        image_available,
...
/////////////////////////////////////
/////////////////////////////////////
auto SwapChain::do_init(view::Surface&& surface, const math::uextent2& extent, VkSwapchainKHR old_swapchain) noexcept
  -> Expected<void> {
    const auto& device          = device();
    const auto& device_table    = device.device_table();
    ...
    const auto capabilities = Try(vk::call_checked<VkSurfaceCapabilitiesKHR>(vkGetPhysicalDeviceSurfaceCapabilitiesKHR,
                                                                             ...
                                                                             surface));
    const auto
      formats = Try(vk::enumerate_checked<VkSurfaceFormatKHR>(vkGetPhysicalDeviceSurfaceFormatsKHR, physical_device, surface));
