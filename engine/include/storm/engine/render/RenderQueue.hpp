...
namespace storm::engine {
    class STORMKIT_PUBLIC RenderQueue: public core::NonCopyable {
      public:
        ...
        RenderQueue(Engine &engine, entities::EntityManager &manager, core::UInt32 buffering_count, std::string_view system_name);
        ~RenderQueue();
        ...
        [[nodiscard]] FrameGraphResourceID drawInstanceBufferID() const noexcept;
        ...
        [[nodiscard]] core::ArraySize drawInstanceCount() const noexcept;
