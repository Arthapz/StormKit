...
/////////////////////////////////////
/////////////////////////////////////
inline auto RenderQueue::drawInstanceBufferID() const noexcept -> FrameGraphResourceID {
...
/////////////////////////////////////
/////////////////////////////////////
inline auto RenderQueue::drawInstanceCount() const noexcept -> core::ArraySize {
    return std::size(m_draw_instances);
}
} // namespace storm::engine
