...
enum ImGuiButtonFlags_ {
    ...
    ImGuiButtonFlags_AlignTextBaseLine =
        1 << 11, // vertically align button to match text baseline - ButtonEx() only // FIXME:
...
enum ImGuiSelectableFlagsPrivate_ {
    ...
    ImGuiSelectableFlags_DrawHoveredWhenHeld =
        1
        << 24, // Always show active when held, even is not hovered. This concept could probably be
...
namespace ImGui {
    ...
    IMGUI_API bool
        IsPopupOpen(ImGuiID id); // Test for id within current popup stack level (currently begin-ed
