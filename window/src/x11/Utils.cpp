...
/////////////////////////////////////
/////////////////////////////////////
storm::window::MouseButton
	x11MouseButtonToStormMouseButton(xcb_button_t button) {
	switch (button) {
	...
	case XCB_BUTTON_INDEX_4:
		return storm::window::MouseButton::BUTTON1;
	case XCB_BUTTON_INDEX_5:
		return storm::window::MouseButton::BUTTON2;
	}
...
xcb_window_t defaultRootWindow(xcb_connection_t *connection,
                               int32_t screen_id) {
