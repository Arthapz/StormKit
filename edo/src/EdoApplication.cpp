...
#include <generated/Configure.hpp>
...
#include <storm/render/core/Context.hpp>
...
EdoApplication::EdoApplication() : m_event_handler{m_window} {
	...
	m_window_name =
		...
		"CPU: {} us | FPS: {} / sec";
	m_context = storm::render::Context::createContext(
		storm::render::Context::Backend::Vulkan);
	LogHandler::ilog("EDO"_module, "Using {} Backend", m_context->backend());

	m_surface = m_context->createSurface(m_window);

	auto &physical_device = m_context->pickPhysicalDevice(*m_surface);
	LogHandler::ilog(
		"EDO"_module,
...
void EdoApplication::initPipeline() {
	...
	m_sprite_vertex_shader =
        m_device->createShader(RESOURCE_DIR / "shaders/sprite_vertex.spv",
                               storm::render::Shader::Language::SPIRV,
							   storm::render::ShaderType::Vertex);
	m_sprite_fragment_shader =
		m_device->createShader(RESOURCE_DIR / "shaders/sprite_fragment.spv",
                               storm::render::Shader::Language::SPIRV,
	...
	m_map_vertex_shader =
		m_device->createShader(RESOURCE_DIR / "shaders/map_vertex.spv",
                               storm::render::Shader::Language::SPIRV,
                               storm::render::ShaderType::Vertex);
	m_map_fragment_shader =
		m_device->createShader(RESOURCE_DIR / "shaders/map_fragment.spv",
                               storm::render::Shader::Language::SPIRV,
                               storm::render::ShaderType::Fragment);
...
void EdoApplication::initScene() {
	...
	const auto buffer_descriptor =
		storm::render::BufferDescriptor{.binding = 0,
                                        .buffer	 = *m_map_tileset_info_buffer,
