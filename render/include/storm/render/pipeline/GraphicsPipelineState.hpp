...
namespace storm::render {
	struct GraphicsPipelineVertexInputState {
		VertexBindingDescriptions binding_descriptions;
		VertexInputAttributeDescriptions input_attribute_descriptions;
	};
	...
	struct GraphicsPipelineLayout {
        std::vector<DescriptorSetLayoutCRef> descriptor_set_layouts;
	};
