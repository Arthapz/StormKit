...
set(CORE_LIB_NAME "${_IMPORT_PREFIX}/${LIB_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}StormKit-core-debug${LIB_SUFFIX}")
set(CORE_BIN_NAME "${_IMPORT_PREFIX}/${BIN_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}StormKit-core-debug${BIN_SUFFIX}")
...
set(ENGINE_LIB_NAME "${_IMPORT_PREFIX}/${LIB_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}StormKit-engine-debug${LIB_SUFFIX}")
set(ENGINE_BIN_NAME "${_IMPORT_PREFIX}/${BIN_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}StormKit-engine-debug${BIN_SUFFIX}")
...
set(ENTITIES_LIB_NAME "${_IMPORT_PREFIX}/${LIB_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}StormKit-entities-debug${LIB_SUFFIX}")
set(ENTITIES_BIN_NAME "${_IMPORT_PREFIX}/${BIN_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}StormKit-entities-debug${BIN_SUFFIX}")
...
set(IMAGE_LIB_NAME "${_IMPORT_PREFIX}/${LIB_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}StormKit-image-debug${LIB_SUFFIX}")
set(IMAGE_BIN_NAME "${_IMPORT_PREFIX}/${BIN_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}StormKit-image-debug${BIN_SUFFIX}")
...
set(LOG_LIB_NAME "${_IMPORT_PREFIX}/${LIB_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}StormKit-log-debug${LIB_SUFFIX}")
set(LOG_BIN_NAME "${_IMPORT_PREFIX}/${BIN_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}StormKit-log-debug${BIN_SUFFIX}")
...
set(MAIN_LIB_NAME "${_IMPORT_PREFIX}/lib/libStormKit-main-debug.a")
...
set(MODULE_LIB_NAME "${_IMPORT_PREFIX}/${LIB_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}StormKit-module-debug${LIB_SUFFIX}")
set(MODULE_BIN_NAME "${_IMPORT_PREFIX}/${BIN_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}StormKit-module-debug${BIN_SUFFIX}")
...
set(RENDER_LIB_NAME "${_IMPORT_PREFIX}/${LIB_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}StormKit-render-debug${LIB_SUFFIX}")
set(RENDER_BIN_NAME "${_IMPORT_PREFIX}/${BIN_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}StormKit-render-debug${BIN_SUFFIX}")
...
set(WINDOW_LIB_NAME "${_IMPORT_PREFIX}/${LIB_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}StormKit-window-debug${LIB_SUFFIX}")
set(WINDOW_BIN_NAME "${_IMPORT_PREFIX}/${BIN_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}StormKit-window-debug${BIN_SUFFIX}")
