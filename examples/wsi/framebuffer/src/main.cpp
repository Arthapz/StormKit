...
auto update_pixels(stormkit::ThreadPool&      pool,
                   std::vector<rgbcolor<u8>>& pixels,
                   const auto&                extent) noexcept {
    ...
    parallel_for(pool,
                 ...
                 [&rect, data, &extent](auto x_y) mutable noexcept {
