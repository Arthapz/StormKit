...
namespace stormkit { inline namespace core {
    ...
    namespace meta { namespace details {
        ...
        using AccessClosureInvokeParameter = meta::If<Mode == LockAccessMode::READ_ONLY, const ReferenceType, ReferenceType>;
    ...
    export {
        ...
        class STORMKIT_CORE_API Locked {
          ...
          public:
            ...
            template<
              LockAccessMode Mode,
              std::invocable<meta::details::AccessClosureInvokeParameter<typename meta::details::LockedValueType<T>::Type&, Mode>>
                Closure,
            ...
            class Access {
              public:
                ...
                using RefContainerType = std::
                  conditional_t<Mode == LockAccessMode::READ_ONLY, ref<const ValueType>, ref<ValueType>>;
