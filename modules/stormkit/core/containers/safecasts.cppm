...
export namespace stormkit { inline namespace core {
    ...
    [[nodiscard]]
    constexpr auto tag_invoke(as_fn<Bytes>, From& value, const std::source_location& = std::source_location::current()) noexcept
...
namespace stormkit { inline namespace core {
    ...
    constexpr auto tag_invoke(as_fn<Bytes>, From& value, const std::source_location&) noexcept
      -> array_view<meta::ForwardConst<From, byte>, get_byte_extent_value_of<From, 1>> {
