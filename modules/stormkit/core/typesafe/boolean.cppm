...
namespace stormkit { inline namespace core {
    ...
    constexpr Boolean::Boolean(bool value) noexcept
        : m_value { value } {
    }
    ...
    /////////////////////////////////////
    STORMKIT_FORCE_INLINE
    constexpr auto Boolean::operator=(bool value) noexcept -> Boolean& {
        m_value = value;
        return *this;
    }
    ...
    /////////////////////////////////////
    STORMKIT_FORCE_INLINE
    constexpr auto Boolean::operator!() const noexcept -> Boolean {
