...
namespace stormkit { inline namespace core {
    ...
    template<typename U>
    STORMKIT_FORCE_INLINE
    constexpr auto AsFn<T>::operator()(U&& value, const std::source_location& location) noexcept -> decltype(auto) {
