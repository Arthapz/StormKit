...
export namespace stormkit::gpu {
    ...
    class STORMKIT_GPU_API PipelineCache {
      ...
      public:
        ...
        static auto try_load(const Device& device, std::filesystem::path cache_path) noexcept -> LoadSaveExpected<PipelineCache>;
      ...
      private:
        auto do_init(const Device&) noexcept -> LoadSaveExpected<void>;
    ...
    class STORMKIT_GPU_API PipelineLayout {
      ...
      public:
        ...
        static auto create(const Device& device, const RasterPipelineLayout& layout) noexcept -> Expected<PipelineLayout>;
        ...
        PipelineLayout(const Device& device, const RasterPipelineLayout& layout, PrivateFuncTag) noexcept;
    ...
    class STORMKIT_GPU_API Pipeline {
      ...
      public:
        ...
        static auto create(const Device&                    device,
                           ...
                           OptionalRef<const PipelineCache> cache = std::nullopt) noexcept -> Expected<Pipeline>;
      ...
      private:
        auto do_init(const PipelineLayout&,
                     OptionalRef<const RenderPass>,
                     OptionalRef<const RasterPipelineRenderingInfo>,
...
namespace stormkit::gpu {
    ...
    inline PipelineCache::PipelineCache(const Device& device, std::filesystem::path path, PrivateFuncTag) noexcept
    ...
    /////////////////////////////////////
    STORMKIT_FORCE_INLINE
    inline auto PipelineCache::try_load(const Device& device, std::filesystem::path cache_path) noexcept
    ...
    inline auto PipelineLayout::do_init() noexcept -> Expected<void> {
        ...
        const auto push_constant_ranges = m_layout.push_constant_ranges
                                          | stdv::transform([](auto&& push_constant_range) noexcept {
                                                return VkPushConstantRange {
                                                    .stageFlags = to_vk<VkShaderStageFlags>(push_constant_range.stages),
        ...
        m_vk_handle = Try(vk_call<VkPipelineLayout>(m_vk_device_table->vkCreatePipelineLayout, m_vk_device, &create_info, nullptr)
